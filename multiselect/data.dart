...
ManageName unassignedData =
    ManageName(-1, "Unassigned", false, -1, Colors.blue, "Group 2");

List<ManageName> mainDataList = [
  new ManageName(1, "Ram Singh", false, 0, Colors.red, "Group 1"),
  new ManageName(2, "Pawan Arora Dev", false, 1, Colors.yellow, "Group 1"),
  new ManageName(3, "Amit Singh", false, 2, Colors.purple, "Group 2"),
  new ManageName(4, "Mohit Rahu ", false, 3, Colors.blue, "Group 2"),
  new ManageName(5, "Neha Sharma ", false, 4, Colors.amberAccent, "Group 2"),
  new ManageName(6, "Mohit Sahu", false, 5, Colors.blueGrey, "Group 3"),
  new ManageName(7, "Priya Sharma", false, 6, Colors.teal, "Group 3"),
  new ManageName(
      8, "Akhilesh Arora", false, 7, Colors.blue.shade200, "Group 3"),
  new ManageName(9, "Aditaya Sahu", false, 8, Colors.red.shade300, "Group 3"),
  new ManageName(10, "Narendra Pal", false, 9, Colors.grey[600], "Group 1"),
